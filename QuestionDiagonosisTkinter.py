...
class MainForm(Frame):
    ...
    def createWidget(self):
        ...
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="Malav Patel", bg="white", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam1.pack()
        self.lblTeam3=Label(self, text="Prit Thakkar", bg="white", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam3.pack()
        self.lblTeam3=Label(self, text="Dhruv Vyas", bg="white", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam3.pack()
